...
columns_drop = ["ID_CLIENT", "CLERK_TYPE", "QUANT_ADDITIONAL_CARDS", "EDUCATION_LEVEL", "CITY_OF_BIRTH", "FLAG_MOBILE_PHONE", "QUANT_SPECIAL_BANKING_ACCOUNTS", "PROFESSIONAL_STATE",
"PROFESSIONAL_CITY", "PROFESSIONAL_BOROUGH", "PROFESSIONAL_PHONE_AREA_CODE", "MATE_PROFESSION_CODE", "MATE_EDUCATION_LEVEL", "FLAG_HOME_ADDRESS_DOCUMENT", "FLAG_RG", "FLAG_CPF",
"FLAG_INCOME_PROOF", "FLAG_ACSP_RECORD", "CITY_OF_BIRTH", "APPLICATION_SUBMISSION_TYPE", "RESIDENCIAL_BOROUGH", "RESIDENCIAL_PHONE_AREA_CODE", "MONTHS_IN_THE_JOB",
"PROFESSIONAL_ZIP_3", "POSTAL_ADDRESS_TYPE", "RESIDENCIAL_CITY", "PERSONAL_MONTHLY_INCOME", "OTHER_INCOMES", "PROFESSION_CODE"]
...
# List of all the columns in the dataframe. List_columns = X_train.columns
...
# Columns that must be converted to int64 before preprocessing
columns_toint = ["PAYMENT_DAY","MARITAL_STATUS","NACIONALITY","FLAG_EMAIL","FLAG_VISA","FLAG_MASTERCARD","FLAG_DINERS",
"FLAG_AMERICAN_EXPRESS","FLAG_OTHER_CARDS","PERSONAL_ASSETS_VALUE","QUANT_CARS","OCCUPATION_TYPE","PRODUCT","RESIDENCIAL_ZIP_3","ALL_INCOMES","QUANT_BANKING_ACCOUNTS"]
 
# Columns that must be converted to float64 before preprocessing
columns_tofloat = ["RESIDENCE_TYPE","MONTHS_IN_RESIDENCE"]